# SHATTA — Mobile (iOS + Android)

SHATTA ships as a Capacitor shell around the live web app. The native apps load
...
- Privacy: SHATTA collects coarse/precise location, photos, and account email.

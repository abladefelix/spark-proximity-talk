...
export function ChatPanel({
  ...
  return (
    <div className={className ?? "flex min-h-screen min-w-0 flex-col bg-transparent"}>
      ...
      <div ref={messagesRef} data-scrollable data-selectable className="min-h-0 flex-1 space-y-3 overflow-y-auto overscroll-contain rounded-t-[2rem] bg-transparent px-4 pb-5 pt-6">

    ...
    <ChatSheetContext.Provider value={value}>
      ...
      {matchId && (
        <div
          ...
          aria-modal="true"
          aria-label="Chat"
          className="fixed inset-0 z-[70] flex h-full w-full flex-col overflow-hidden overscroll-none bg-background animate-in fade-in slide-in-from-right-2 duration-200"
          style={{
            // The web view resizes for the keyboard, so the overlay simply
            // follows the visible height like a native screen.
